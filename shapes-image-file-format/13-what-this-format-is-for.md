...
| **P-06b** | **Push `bitsPerEdge` *above* 1.73** | Report 26 found the "correct" value is worse: the constant is a straightening pressure, not a cost, and over-weighting walls buys bytes. The upward direction is untested and is the opposite of what P-06 proposed |
