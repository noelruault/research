...
cwebp -q 34 -quiet sierra.png -o /tmp/a.webp; dwebp -quiet /tmp/a.webp -o /tmp/a.png
emit a_webp webp "WebP q34" "$(stat -f%z /tmp/a.webp)" "$(psnr /tmp/a.png)" /tmp/a.png

avifenc -q 30 -s 4 sierra.png /tmp/a.avif >/dev/null 2>&1; avifdec /tmp/a.avif /tmp/a.png >/dev/null 2>&1
emit a_avif avif "AVIF q30" "$(stat -f%z /tmp/a.avif)" "$(psnr /tmp/a.png)" /tmp/a.png

emit a_shapes shapes "shape coder, 1,685 regions" 12202 28.66 render_1685_28.66.png

sips -s format jpeg -s formatOptions 44 sierra.png --out /tmp/a.jpg >/dev/null 2>&1
...
cwebp -q 14 -quiet sierra.png -o /tmp/b.webp; dwebp -quiet /tmp/b.webp -o /tmp/b.png
emit b_webp webp "WebP q14" "$(stat -f%z /tmp/b.webp)" "$(psnr /tmp/b.png)" /tmp/b.png

avifenc -q 18 -s 4 sierra.png /tmp/b.avif >/dev/null 2>&1; avifdec /tmp/b.avif /tmp/b.png >/dev/null 2>&1
emit b_avif avif "AVIF q18" "$(stat -f%z /tmp/b.avif)" "$(psnr /tmp/b.png)" /tmp/b.png
...
cwebp -q 0 -quiet sierra.png -o /tmp/c.webp; dwebp -quiet /tmp/c.webp -o /tmp/c.png
emit c_webp webp "WebP q0 (its floor)" "$(stat -f%z /tmp/c.webp)" "$(psnr /tmp/c.png)" /tmp/c.png
