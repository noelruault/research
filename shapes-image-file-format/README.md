...
- **At lossless it slips under AVIF and PNG, and still loses to WebP and JPEG XL.** The exact region partition of a 4K photograph costs **11,654,978 B** against WebP-lossless's 7,718,506 (**1.51×**) and JPEG XL's 6,468,598 (**1.80×**), while coming in just under AVIF's 11,969,137 and 5% under PNG's 12,278,280. The partition degenerates to 1.305 px per region, the walls become nearly free at 0.45 bits/edge, and **93% of the bill is colour** — at which point the region coder simply *is* a raster coder with one predictor where WebP has fourteen. *(This row read 12,159,385 B until 2026-07-29, when it turned out to be priced with a weaker colour predictor than the rest of its own table — ledger item B6.)*
