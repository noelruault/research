...
client_profile: cable        # API consumers often other servers / SDKs, not phones
...
- Live HTTP server is NOT running. Skip Phase 7 (over-the-wire). File-level only.
