...
| B2 | **Contour coder, never examined** | It is the *chosen* coder below ~1,400 regions, where walls are 92–96% of the bill. Every wall result so far (report 09) improves CAE and is therefore worth **exactly zero** at the low-rate arm | OPEN — highest untouched-to-share ratio |
